...
const payloadTaskMap = {
  'Fire-Support-UGV': [
    ...
    { actionType: 'recon-strike', name: '侦察打击', defaultParam: { time: 180, area: [] } },
    { actionType: 'gun-shot', name: '机枪打击', defaultParam: { time: 30, sort: 1, num: 1, points: [] } },
  ...
  'Patrol-UGV': [
    { actionType: 'lens-recon', name: '光电侦察', defaultParam: { type: 2, mode: 3, time: 120, area: [] } },
    { actionType: 'recon-strike', name: '巡逻车侦察打击', defaultParam: { time: 180, tarty: 6, attr: 1, thr: 80, dam: 1, blk: 2, figt: 2, sug: 3, ammo: 10, strategy: 0, area: [] } },
    { actionType: 'gun-shot', name: '机枪打击', defaultParam: { time: 30, sort: 1, num: 1, points: [] } },
    { actionType: 'acoustic-deterrence', name: '强声拒止', defaultParam: { time: 60, tarty: 1, attr: 2, thr: 50, dam: 0, blk: 0, figt: 0, sug: 0, ammo: 0, strategy: 0, area: [] } },
    { actionType: 'light-deterrence', name: '强光拒止', defaultParam: { time: 60, tarty: 1, attr: 2, thr: 50, dam: 0, blk: 0, figt: 0, sug: 0, ammo: 0, strategy: 0, area: [] } },
  ],
  'Electronic-UGV': [
    { actionType: 'electronic-recon', name: '电磁侦察', defaultParam: { mode: 3, time: 300, num: 1, freqtype: 62, frequency: [], area: [] } },
    { actionType: 'electronic-jamming', name: '电磁突击', defaultParam: { mode: 3, time: 300, sort: 1, num: 1, freqtype: 62, frequency: [], area: [], protect: {} } },
